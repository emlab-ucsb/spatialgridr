test_that("returns Samoa example of gridded data - raster", {
  expect_s4_class(suppressWarnings(get_data_in_grid(spatial_grid = get_grid(area_polygon = get_boundary(name = "Samoa", type = "eez", country_type = "country"),
...
test_that("returns Samoa example of raw data  - sf", {
  expect_s3_class(suppressWarnings(get_data_in_grid(area_polygon = get_boundary(name = "Samoa", type = "eez", country_type = "country"),
                                                         dat = readRDS(system.file("extdata", "ridges.rds", package = "spatialgridr")))),
                  class = "sf")
...
test_that("returns kiribati example (antimeridian example) of gridded data - raster", {
  expect_s4_class(suppressWarnings(get_data_in_grid(spatial_grid = get_grid(area_polygon = get_boundary(name = "Kiribati", type = "eez", country_type = "sovereign"),
...
test_that("returns kiribati example (antimeridian example) of raw data - sf", {
  expect_s3_class(suppressWarnings(get_data_in_grid(area_polygon = get_boundary(name = "Kiribati", type = "eez", country_type = "sovereign"),
                                                         dat = readRDS(system.file("extdata", "ridges.rds", package = "spatialgridr")),
                                                         antimeridian = TRUE)),
                  class = "sf")
...
test_that("returns samoa example of multi-column sf gridded data - sf", {
  expect_s3_class(suppressWarnings(get_data_in_grid(spatial_grid = get_grid(area_polygon = get_boundary(name = "Samoa", type = "eez", country_type = "country"),
                                                    projection_crs = '+proj=laea +lon_0=-172.5 +lat_0=0 +datum=WGS84 +units=m +no_defs',
                                                    resolution = 5000,
                                                    option = "sf_square"),
